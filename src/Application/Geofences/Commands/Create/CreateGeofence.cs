...
public class CreateGeofenceCommandHandler(IGeofenceWriter writer, IUserReader userReader, IUser user, IPlatformFeatureReader platformFeatureReader) : IRequestHandler<CreateGeofenceCommand, GeofenceVm>
{
